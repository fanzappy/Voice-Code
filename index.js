...
exports.analyzeRecording = (event) => {
  ...
  const storage = require('@google-cloud/storage')();
   ...
   const nnl = require('@google-cloud/language');
// Instantiates a client
 console.log(`BBBCCC`);
const nl = new nnl.LanguageServiceClient();


     console.log(`CCC`);
// Imports the Google Cloud client library
const sspeech = require('@google-cloud/speech');
// Creates a client
const speech = new sspeech.SpeechClient();
  
  /* 
   * const nnl = require('@google-cloud/language');
   
  const sspeech = require('@google-cloud/speech');
  const sstorage = require('@google-cloud/storage');
 

//added by Lee 5/22/2018
// Your Google Cloud Platform project ID
const projectId = 'red-air-204920';
 
// Creates a client
const storage = new sstorage({
  projectId: projectId,
});
 
 const speech = new sspeech({
  projectId: projectId,
});
